const foods = [
  {
    ...
    "tint": "#e9f5ee",
    "reference": 162,
    "sourceDate": "令和8年8月24日の週",
    "comment": "公式最新値では平年比138%です。高値圏のため、必要分だけの購入が無難です。直近は値下がりしています。",
    "history": [
      201,
      197,
      201,
  ...
  },
  {
    ...
    "reference": 843,
    "sourceDate": "令和8年8月24日の週",
    "comment": "公式最新値では平年比116%です。高値圏のため、必要分だけの購入が無難です。直近は横ばいです。",
    "history": [
      886,
      916,
      938,
  ...
  },
  {
    ...
    "reference": 440,
    "sourceDate": "令和8年8月24日の週",
    "comment": "公式最新値では平年比126%です。高値圏のため、必要分だけの購入が無難です。直近は値下がりしています。",
    "history": [
      512,
      530,
      550,
  ...
  },
  {
    ...
    "reference": 334,
    "sourceDate": "令和8年8月24日の週",
    "comment": "公式最新値では平年比113%です。高値圏のため、必要分だけの購入が無難です。直近は値下がりしています。",
    "history": [
      364,
      365,
      379,
  ...
  },
  {
    ...
    "reference": 600,
    "sourceDate": "令和8年8月24日の週",
    "comment": "公式最新値では平年比136%です。高値圏のため、必要分だけの購入が無難です。直近は値下がりしています。",
    "history": [
      711,
      766,
      770,
  ...
  },
  {
    ...
    "reference": 491,
    "sourceDate": "令和8年8月24日の週",
    "comment": "公式最新値では平年比96%です。平年より安めで、買い時寄りです。直近は横ばいです。",
    "history": [
      505,
      511,
      518,
